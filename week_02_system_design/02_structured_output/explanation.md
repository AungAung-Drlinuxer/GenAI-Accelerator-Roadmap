...
Error message တွေက model အတွက် တကယ့် အသုံးဝင်တဲ့ ညွှန်ကြားချက်တွေပါ — ဘယ် field မှားလဲ၊ ဘာလိုချင်လဲ ဆိုတာ တိတိကျကျ ပြောပြထားလို့ ဒုတိယအကြိမ်မှာ အောင်မြင်နိုင်ခြေ များပါတယ်။
